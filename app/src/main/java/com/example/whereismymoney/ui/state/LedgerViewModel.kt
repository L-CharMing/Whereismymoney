...
data class LedgerUiState(
    val categories: List<com.example.whereismymoney.data.model.ExpenseCategory> = emptyList(),
    ...
    val monthlyBreakdown: List<com.example.whereismymoney.data.model.MonthlyCategorySummary> = emptyList()
)

private fun LedgerSnapshot.toUiState(): LedgerUiState {
